...
const { getHubById } = require('./controllers/hub.controller');
...
app.get("/", (req, res) => {
     res.send('CargoFlow Admin Service');
})
...
app.get('/health', (req, res) => {
     res.status(200).json({
          success: true,
          message: 'CargoFlow Admin Service is healthy',
          timestamp: new Date().toISOString()
     });
});

// API Routes - All protected by auth middleware
app.get('/hub/internal/:hubId', internalAuth, getHubById);
