...
exports.createPaymentOrder = asyncHandler(async (req, res) => {
     const { shipmentBookingId, amount, userId, idempotencyKey } = req.body;
     ...
     const result = await paymentService.createPaymentOrder(shipmentBookingId, amount, userId, idempotencyKey);
