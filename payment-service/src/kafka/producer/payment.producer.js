...
class PaymentProducer {
     ...
     async publishPaymentSuccess(paymentOrderId, shipmentBookingId, gatewayPaymentId, amount) {
     ...
     async publishPaymentFailed(paymentOrderId, shipmentBookingId, reason) {
          return this.sendMessage(
